...
export const mockCampaigns: Campaign[] = [
  {
    ...
    statusHistory: [
      { status: 'draft', changedAt: '2026-06-01T10:00:00', operator: '运营专员' },
      { status: 'pending', changedAt: '2026-06-05T14:20:00', operator: '运营专员', comment: '提交审核' },
      { status: 'approved', changedAt: '2026-06-10T15:30:00', operator: '审核主管', comment: '活动力度合理，审核通过' },
      { status: 'active', changedAt: '2026-06-15T00:00:00', operator: '系统自动' },
    ],
  ...
  },
  {
    ...
    statusHistory: [
      { status: 'draft', changedAt: '2026-06-12T14:00:00', operator: '运营专员' },
      { status: 'pending', changedAt: '2026-06-13T10:15:00', operator: '运营专员', comment: '提交审核' },
    ],
  ...
  },
  {
    ...
    statusHistory: [
      { status: 'draft', changedAt: '2026-06-08T09:00:00', operator: '运营专员' },
      { status: 'rejected', changedAt: '2026-06-09T11:00:00', operator: '审核主管', comment: '赠品库存不足，请调整' },
      { status: 'pending', changedAt: '2026-06-10T16:00:00', operator: '运营专员', comment: '修改赠品后重新提交' },
      { status: 'approved', changedAt: '2026-06-11T11:20:00', operator: '审核主管', comment: '赠品库存充足，可以上线' },
    ],
  ...
  },
  {
    ...
    rules: [],
    statusHistory: [
      { status: 'draft', changedAt: '2026-06-05T16:00:00', operator: '运营专员' },
    ],
  ...
  },
  {
    ...
    reviewComment: '完成度不错',
    statusHistory: [
      { status: 'draft', changedAt: '2026-05-20T10:00:00', operator: '运营专员' },
      { status: 'pending', changedAt: '2026-05-23T14:30:00', operator: '运营专员', comment: '提交审核' },
      { status: 'approved', changedAt: '2026-05-25T16:00:00', operator: '审核主管', comment: '可如期上线' },
      { status: 'active', changedAt: '2026-06-01T00:00:00', operator: '系统自动' },
      { status: 'ended', changedAt: '2026-06-08T09:00:00', operator: '系统自动', comment: '活动自然结束' },
    ],
